...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-4">
                    ...
                    <h1 class="text-xl font-bold">Wasit - Kontrol Skor</h1>
                </div>
                <div class="flex items-center space-x-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600">Pilih pertandingan untuk mengontrol skor</p>
        </div>
        ...
        <?php if (empty($activeMatches)): ?>
            <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                ...
                <p class="text-gray-500">Admin perlu mengaktifkan pertandingan terlebih dahulu.</p>
            </div>
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php foreach ($activeMatches as $match): ?>
                    <a href="score-control.php?match_id=<?= $match['id'] ?>" 
                       class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transform hover:scale-105 transition-all border-l-4 border-orange-500">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200">
                            <span class="text-orange-600 font-semibold">
                                Kelola Skor <i class="fas fa-arrow-right ml-2"></i>
                            </span>
                        </div>
                    </a>
                <?php endforeach; ?>
